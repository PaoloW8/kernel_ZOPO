...
void hall_eint_func(void)
{
	...
	{
		mt65xx_eint_set_polarity(CUST_EINT_HALL_NUM, HALL_FAR);
		hall_cur_eint_state = HALL_NEAR;
	}
	else
	{
		mt65xx_eint_set_polarity(CUST_EINT_HALL_NUM, HALL_NEAR);
...
static inline int hall_setup_eint(void)
{
	...
	mt65xx_eint_registration(CUST_EINT_HALL_NUM, CUST_EINT_HALL_DEBOUNCE_EN, !((bool)hall_cur_eint_state), hall_eint_func, 0);
	mt65xx_eint_unmask(CUST_EINT_HALL_NUM);  
