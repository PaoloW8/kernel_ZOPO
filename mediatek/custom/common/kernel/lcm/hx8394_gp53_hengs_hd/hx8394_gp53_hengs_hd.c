...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	*/
    ...
    {0xc7,2,{0x00,0x30}},
    {REGFLAG_DELAY,1,{}},
    {0xe0,34,{0x01,0x0a,0x13,0x0d,0x0d,0x33,0x28,0x34,0x44,0x4c,0x91,0x56,0x97,0x16,0x16,0x07,0x10,0x01,0x0a,0x13,0x0d,0x0d,0x33,0x28,0x34,0x44,0x4c,0x91,0x56,0x97,0x16,0x16,0x07,0x10}},
    {REGFLAG_DELAY,1,{}},
    {0xbf,2,{0x06,0x10}},
    {REGFLAG_DELAY,1,{}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_sync_active				= 50;//86
		params->dsi.horizontal_backporch				= 90;//55
		params->dsi.horizontal_frontporch				= 90;//55
...
// ---------------------------------------------------------------------------
LCM_DRIVER  hx8394_gp53_hengs_hd_lcm_drv =
{
    .name			= "hx8394_gp53_hengs_hd",
