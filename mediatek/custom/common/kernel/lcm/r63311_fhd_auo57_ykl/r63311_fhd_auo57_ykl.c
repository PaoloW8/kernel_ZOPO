...
static void init_lcm_registers(void)
{
    ...
    data_array[1]=0x80f730c2;//cmd mode
    data_array[2]=0x00000c0a;//cmd mode
    dsi_set_cmdq(data_array, 3, 1);
    ...
    data_array[2]=0x00030003;//cmd mode
	  data_array[3]=0x00000000;//cmd mode
    data_array[4]=0x00000000;//cmd mode
	  data_array[5]=0x0e190900;//cmd mode
	  data_array[6]=0x49470100;//cmd mode
	  data_array[7]=0x03000300;//cmd mode
    ...
    data_array[1]=0x0f0000cd;//cmd mode
    dsi_set_cmdq(data_array, 2, 1);
    ...
    data_array[1]=0x000020d1;//cmd mode
    data_array[2]=0x100c0804;//cmd mode
	  data_array[3]=0x00000000;//cmd mode
    data_array[4]=0x20043c00;//cmd mode
	  data_array[5]=0x08040000;//cmd mode
	  data_array[6]=0x0000100c;//cmd mode
