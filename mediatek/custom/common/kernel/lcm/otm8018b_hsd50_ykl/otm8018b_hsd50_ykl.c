...
#define LCM_OTM8018B_ID				 (0x800902)
...
//static unsigned int flick=0x30;
...
/*
	...
	data_array[1] = (0x00<< 24) | (0x00 << 16) | (flick << 8) | 0xd9;
	dsi_set_cmdq(&data_array, 2, 1);
       flick=flick+2;
*/
}
...
#endif
	return (LCM_OTM8018B_ID == id) ? 1 : 0;
}

LCM_DRIVER otm8018b_dsi_lcm_drv = {
	.name = "otm8018b_hsd50_ykl",
