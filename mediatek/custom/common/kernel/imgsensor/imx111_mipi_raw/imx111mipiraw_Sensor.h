...
/* X/Y Starting point */
#define IMX111MIPI_IMAGE_SENSOR_PV_STARTX       3
#define IMX111MIPI_IMAGE_SENSOR_PV_STARTY       3	// The value must bigger or equal than 1.
#define IMX111MIPI_IMAGE_SENSOR_CAP_STARTX		((IMX111MIPI_IMAGE_SENSOR_PV_STARTX * IMAGE_SENSOR_H_DECIMATION)+1)
#define IMX111MIPI_IMAGE_SENSOR_CAP_STARTY		((IMX111MIPI_IMAGE_SENSOR_PV_STARTY * IMAGE_SENSOR_V_DECIMATION)+1)		// The value must bigger or equal than 1.
#define IMX111MIPI_IMAGE_SENSOR_VIDEO_STARTX       3
#define IMX111MIPI_IMAGE_SENSOR_VIDEO_STARTY       3	// The value must bigger or equal than 1.
