...
*/
	...
	OV5640YUV_write_cmos_sensor(0x5583, 0x38); //40
	OV5640YUV_write_cmos_sensor(0x5584, 0x38); //10
...
*/
	...
	OV5640YUV_write_cmos_sensor(0x5184, 0x25);   
	OV5640YUV_write_cmos_sensor(0x5185, 0x24);   
	OV5640YUV_write_cmos_sensor(0x5186, 0x18);   
	OV5640YUV_write_cmos_sensor(0x5187, 0x24);   
	OV5640YUV_write_cmos_sensor(0x5188, 0x25);   
	OV5640YUV_write_cmos_sensor(0x5189, 0x81);   
	OV5640YUV_write_cmos_sensor(0x518a, 0x6b);   
	OV5640YUV_write_cmos_sensor(0x518b, 0xce);   
	OV5640YUV_write_cmos_sensor(0x518c, 0x99);   
	OV5640YUV_write_cmos_sensor(0x518d, 0x39);   
	OV5640YUV_write_cmos_sensor(0x518e, 0x32);   
	OV5640YUV_write_cmos_sensor(0x518f, 0x62);   
	OV5640YUV_write_cmos_sensor(0x5190, 0x57);   
	OV5640YUV_write_cmos_sensor(0x5191, 0xf5);   
	OV5640YUV_write_cmos_sensor(0x5192, 0xa);  
	OV5640YUV_write_cmos_sensor(0x5193, 0x70);   
	OV5640YUV_write_cmos_sensor(0x5194, 0xf0);   
	OV5640YUV_write_cmos_sensor(0x5195, 0xf0);   
	OV5640YUV_write_cmos_sensor(0x5196, 0x3 );  
	OV5640YUV_write_cmos_sensor(0x5197, 0x1 );  
	OV5640YUV_write_cmos_sensor(0x5198, 0x4 );  
	OV5640YUV_write_cmos_sensor(0x5199, 0x96);   
	OV5640YUV_write_cmos_sensor(0x519a, 0x4 );  
	OV5640YUV_write_cmos_sensor(0x519b, 0x0 );  
	OV5640YUV_write_cmos_sensor(0x519c, 0x8);  
	OV5640YUV_write_cmos_sensor(0x519d, 0x25);   
	OV5640YUV_write_cmos_sensor(0x519e, 0x38);  										
	//CCM                                   
	OV5640YUV_write_cmos_sensor(0x5381, 0x1c);
	OV5640YUV_write_cmos_sensor(0x5382, 0x5a);
...
/* Vanzo:xujun1 on: Sat, 17 Aug 2013 11:26:11 +0800
 * aphone UI
 */
