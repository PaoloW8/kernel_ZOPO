...
void imx135VideoFullSizeSetting(void)//16:9   6M

{	
	SENSORDB("imx135VideoFullSizeSetting enter:");
 ...
 //PLL setting 
    ...
    SENSORDB("imx135VideoFullSizeSetting exit");
}


void imx135PreviewSetting(void)
{	

   SENSORDB("imx135PreviewSetting enter:");
  //PLL setting 
	IMX135MIPI_write_cmos_sensor(0x0100,0x00);// STREAM STop
	...
	IMX135MIPI_write_cmos_sensor(0x0100,0x01);// STREAM START
     ...
     SENSORDB("imx135PreviewSetting exit");
}
...
//#if defined (VANZO_USE_MAIN_CAM)
printk("VANZO_USE_MAIN_CAM = %s\n",VANZO_USE_MAIN_CAM);
	if(strstr(VANZO_USE_MAIN_CAM, "imx135") != NULL)
	{
		if(firstin)
		{
			firstin = 0;
    ...
    do {		
	  *sensorID =(kal_uint16)((IMX135MIPI_read_cmos_sensor(0x0016)<<8) | IMX135MIPI_read_cmos_sensor(0x0017));   
		...
		printk("imx135 Read Sensor ID  = 0x%04x\n",*sensorID);
	break;
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch (ScenarioId)
    {
     ...
     //   case MSDK_SCENARIO_ID_VIDEO_CAPTURE_MPEG4:
            ...
            pSensorInfo->SensorGrabStartX = IMX135MIPI_IMAGE_SENSOR_PV_STARTX+1; 
            pSensorInfo->SensorGrabStartY = IMX135MIPI_IMAGE_SENSOR_PV_STARTY+1;           		
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			   ...
			   pSensorInfo->SensorPixelClockCount= 3;
			   pSensorInfo->SensorDataLatchCount= 2;
			   pSensorInfo->SensorGrabStartX = IMX135MIPI_IMAGE_SENSOR_VIDEO_STARTX+1; 
			   pSensorInfo->SensorGrabStartY = IMX135MIPI_IMAGE_SENSOR_VIDEO_STARTY+1;				   
			   pSensorInfo->SensorMIPILaneNumber = SENSOR_MIPI_4_LANE;		   
			   pSensorInfo->MIPIDataLowPwr2HighSpeedTermDelayCount = 0; 
			pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = 14; 
			pSensorInfo->MIPICLKLowPwr2HighSpeedTermDelayCount = 0;
       ...
       // case MSDK_SCENARIO_ID_CAMERA_CAPTURE_MEM:
            ...
            pSensorInfo->SensorPixelClockCount= 3;
            pSensorInfo->SensorDataLatchCount= 2;
            pSensorInfo->SensorGrabStartX = IMX135MIPI_IMAGE_SENSOR_CAP_STARTX+1;	//2*IMX135MIPI_IMAGE_SENSOR_PV_STARTX; 
            pSensorInfo->SensorGrabStartY = IMX135MIPI_IMAGE_SENSOR_CAP_STARTY+1;	//2*IMX135MIPI_IMAGE_SENSOR_PV_STARTY;          			
            pSensorInfo->SensorMIPILaneNumber = SENSOR_MIPI_4_LANE;			
            pSensorInfo->MIPIDataLowPwr2HighSpeedTermDelayCount = 0; 
            pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = 14; 
            pSensorInfo->MIPICLKLowPwr2HighSpeedTermDelayCount = 0; 
