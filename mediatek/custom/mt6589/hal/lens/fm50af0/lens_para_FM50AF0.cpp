...
const NVRAM_LENS_PARA_STRUCT FM50AF0_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 FM50AF0_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &FM50AF0_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFM50AF0_getDefaultData = FM50AF0_getDefaultData;
