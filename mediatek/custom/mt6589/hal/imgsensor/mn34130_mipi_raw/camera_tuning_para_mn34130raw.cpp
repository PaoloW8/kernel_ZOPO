...
{{
    ...
    ISPCcmPoly22:{
        ...
        26445,    // i4B_STD
        {  // i4P00[9]
            4977500, -2272500, -145000, -812500, 3782500, -407500, 32500, -2765000, 5292500
        },
        {  // i4P10[9]
            1899361, -2303271, 403910, -79038, -475353, 543807, 221762, 427783, -649545
        },
        {  // i4P01[9]
            1645055, -1932004, 286949, -292386, -407142, 689575, 31514, -314668, 283154
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AWB NVRAM
    {
        ...
        {// CCT estimation
            ...
            {// Rotated X coordinate
                -459,    // i4RotatedXCoordinate[0]
                -354,    // i4RotatedXCoordinate[1]
